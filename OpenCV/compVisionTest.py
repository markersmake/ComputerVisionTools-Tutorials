...
def overlay_mask(mask, image):
    ...
    #calculates the weightless sum of two arrays. in our case image arrays
...
def find_strawberry(image):
    ...
    #take these twko masks and...
    #combine our masks
    mask = mask1 + mask2

    #Step 5 - Segmentation
    kernel = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (15,15))
    mask_closed = cv2.morphologFX(mask, cv2.MORPH_CLOSE, kernel)
    ...
    bgr = cv2.cvtColor(circled, cv2COLOR_RGB2BGR)
